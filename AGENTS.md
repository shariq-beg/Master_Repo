# Master Repo Agent Instructions
...
- Follow this root `AGENTS.md` for all work in `Master_Repo`.
- If a project folder contains its own `AGENTS.md`, read and follow it for that project.
